  ...
  class Users < Grape::API
    ...
    resource :users, requirements: { uid: /[0-9]*/, id: /[0-9]*/ } do
      ...
      post ":id/keys" do
        ...
        key = user.keys.new(declared_params)
      ...
      params do
        requires :uid, type: Integer, desc: 'The ID of the user'
      end
      get ':uid/keys' do
        authenticated_as_admin!
      ...
      params do
        requires :uid, type: Integer, desc: 'The ID of the user'
        requires :id, type: Integer, desc: 'The ID of the SSH key'
      end
      ...
      post ":id/emails" do
        ...
        email = user.emails.new(declared_params)
      ...
      params do
        requires :uid, type: Integer, desc: 'The ID of the user'
        requires :id, type: Integer, desc: 'The ID of the email'
      end
      delete ':uid/emails/:id' do
        ...
        email = user.emails.find_by(id: params[:id])
    ...
    resource :user do
      ...
      get "keys/:id" do
        key = current_user.keys.find_by(id: params[:id])
        not_found!('Key') unless key
